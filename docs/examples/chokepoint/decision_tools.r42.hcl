...
go_tool "submit_company_priorities" {
  ...
  source = <<-GO
    ...
    type Company struct { Company string `json:"company"`; Ticker string `json:"ticker"`; Market string `json:"market"`; Role string `json:"role"`; Priority string `json:"priority"`; RelationshipClaimIDs []string `json:"relationship_claim_ids"`; EconomicExposure EconomicExposure `json:"economic_exposure"`; WhyResearch string `json:"why_research"`; LargestUnknown string `json:"largest_unknown"`; NextCheck string `json:"next_check"` }
